    ...
    public void scan(final JSONArray args) {
        ...
        cordova.getThreadPool().execute(new Runnable() {
            public void run() {
                ...
                intentScan.putExtra("SCAN_WIDTH", height);
                intentScan.putExtra("SCAN_HEIGHT", 160);
                intentScan.putExtra("PROMPT_MESSAGE", "Foque o código de barras no interior do leitor para escaneá-lo.");
                intentScan.putExtra("SCAN_MODE", "ONE_D_MODE");//ONE_D_MODE
